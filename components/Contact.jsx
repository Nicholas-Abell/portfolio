        ...
        <div className='w-full lg:h-screen'>
            <div className='max-w-[1240px] m-auto px-2 py-16 w-full'>
                ...
                <div className='flex justify-center py-12'>
                    <div onClick={scrollToTop} className='dark:text-white dark:hover:text-red-600 dark:bg-black rounded-full shadow-lg shadow-gray-400 dark:hover:shadow-red-600 p-3 hover:shadow-md cursor-pointer ease-in hover:duration-200'>
