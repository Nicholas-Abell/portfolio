        ...
        <div className='w-full py-12 p-2'>
            <div className='max-w-[1240px] mx-auto flex flex-col justify-center h-full'>
                ...
                <div className='grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-8 mt-12'>
                    ...
                    <Skill title='Git' icon={<BsGit size={50} className='text-orange-600' />} />
                    <Skill title='Javascript' icon={<SiJavascript size={50} className='text-yellow-500' />} />
                    <Skill title='Typescript' icon={<SiTypescript size={50} className='text-blue-700' />} />
                    <Skill title='CSS' icon={<FaCss3Alt size={50} className='text-blue-500' />} />
                    <Skill title='SCSS' icon={<FaSass size={50} className='text-pink-400' />} />
