        ...
        <div className='w-full overflow-hidden pt-20'>
            ...
            <div className='mx-auto max-w-[1240px] grid md:grid-cols-5 gap-8 p-8 dark:text-gray-300'>
                <div className='col-span-4'>
                    ...
                    <p className='py-8 dark:text-gray-300'>Curious about new and upcoming movies? Looking for a classic and wonder which streaming service to watch it on?
                    ...
                    <div className='flex items-center gap-4'>
                        <a href='https://movie-database-4bf43.web.app/' className='flex justify-center items-center gap-2 p-2 shadow-gray-400 rounded-xl uppercase neon'>
                            <CgWebsite size={25} className='w-full h-full' />
                            <h3>Live</h3>
                        </a>
                        <a href='https://github.com/Nicholas-Abell/movie_database' className='flex justify-center items-center gap-2 p-2 shadow-gray-400 rounded-xl uppercase neon'>
