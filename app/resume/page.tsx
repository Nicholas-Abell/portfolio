  ...
  return (
    <div className="bg-gray-100 dark:bg-black text-gray-900 dark:text-gray-300 pt-20 flex print:pt-0 print:scale-70">
      <div className="w-[30vh] bg-blue-500 dark:bg-red-700 text-white dark:text-gray-300 py-4">
        ...
        <div className="py-2">
          <h3 className="p-2 font-bold underline underline-offset-4">
            Front End
          </h3>
      ...
      <div className="flex flex-col w-full">
        <div className="px-8 pt-4">
          <p>
            A software developer looking to expand his resume. I make mobile
            responsive websites primarily using react js and tailwind css, but
            am always excited to learn new frameworks or tech stacks. I have
            excelled in my current work place for eleven years and am looking to
            switch to software development full time.
          </p>
        </div>
              ...
              <div className="flex flex-col gap-8">
                ...
                <ul className="flex flex-col gap-4">
                  ...
                  <li className="flex items-center">
                    <RxDot />
                    <p>
                      Use Barflow and SAP to recieve millions of dollars worth
                      of product daily
                    </p>
                  </li>
                  <li className="flex items-center">
              ...
              <div className="flex flex-col gap-8">
                ...
                <ul className="flex flex-col gap-4">
                  ...
                  <li className="flex items-center">
                    <RxDot />
                    <p>
                      Hosted the site on Hostinger, and purchased domain name.
                    </p>
                  </li>
                  <li className="flex items-center">
                    <RxDot />
                    <p>
                      Made sure the site was accessible via the most popular
                      search engines using SEO practices
                    </p>
                  </li>
                </ul>
              </div>
