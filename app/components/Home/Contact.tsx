  ...
  return (
    <div className="w-full lg:h-screen">
      <div className="max-w-[1240px] m-auto px-2 py-16 w-full">
        <p
          id="contact"
          className="text-xl tracking-widest uppercase text-red-800 dark:text-red-600"
        >
          Contact
        </p>
        ...
        <div className="grid lg:grid-cols-5 gap-8">
            ...
            <div className="p-8 lg:p-4 h-full">
              <div className="w-full h-auto flex justify-center items-center">
                <Image
                  src={profileImg}
                  alt="profile"
                  className="w-[50%] lg:w-full rounded-xl hover:scale-105 ease-in duration-300"
                />
              </div>
              <div className="py-8">
          ...
          <div
            id="email"
            className="col-span-3 w-full h-auto shadow-xl shadow-gray-400 rounded-xl lg:p-4 dark:text-gray-400"
          >
            <div className="p-4">
              <form
              ...
              >
                <div className="grid md:grid-cols-2 gap-4 w-full py-2">
                  <div className="flex flex-col">
                    ...
                    <input
                      type="text"
                      className="border-2 rounded-lg p-3 flex border-gray-300 dark:border-red-900 dark:bg-gray-700 dark:text-gray-300"
                    />
                  </div>
                  <div className="flex flex-col">
                ...
                />
                <button className="w-full my-4 p-4 hover:duration-200 ease-in text-gray-800 dark:text-gray-300 dark:hover:shadow-red-600 hover:shadow-md dark:hover:text-red-600">
                  Send Message
                </button>
              </form>
            </div>
