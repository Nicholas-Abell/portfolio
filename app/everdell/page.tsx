      ...
      <div className="mx-auto max-w-[1240px] grid md:grid-cols-5 gap-8 p-8 dark:text-gray-300">
        <div className="col-span-4">
          ...
          <p className="py-8 dark:text-gray-300">
            A score calculator for the worker placement / tableau building board
            game Everdell. This is my first app, and is still used by me and my
            family today. Built in Unity and coded in C#. I have this hosted on
