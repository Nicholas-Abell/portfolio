            ...
            <div className='mx-auto max-w-[1240px] grid md:grid-cols-5 gap-8 p-8 dark:text-gray-300'>
                <div className='col-span-4'>
                    ...
                    <div className='flex items-center gap-4'>
                        <a href='https://nicholas-abell.github.io/wordle_clone/' className='flex justify-center items-center gap-2 p-2 shadow-lg hover:shadow-xl shadow-gray-400 rounded-xl uppercase neon'>
                            <CgWebsite size={25} className='w-full h-full' />
                            <h3>Live</h3>
                        </a>
                        <a href='https://github.com/Nicholas-Abell/wordle_clone' className='flex justify-center items-center gap-2 p-2 shadow-lg hover:shadow-xl shadow-gray-400 rounded-xl uppercase neon'>
